...
class SingelInputAlert: PresentCenterVC {
    override var enableTouchToDismiss: Bool {
        return true
    }
    
    override var controllerSize: CGSize {
        return CGSize(width: 270 , height: 156)
    }
    ...
    init(title: String = "提示", placeText: String, cancleTitle: String = "取消", confirmTitle: String = "确定", single: Bool = false, cancle: (() -> Void)? = nil, confirm: ((String?) -> Void)? = nil) {
        titleStr = title
        placeStr = placeText
...
private extension SingelInputAlert {
    func setupSubviews(){
